  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        cacador: {
          red: "hsl(var(--cacador-red))",
          "red-dark": "hsl(var(--cacador-red-dark))",
          yellow: "hsl(var(--cacador-yellow))",
          "yellow-dark": "hsl(var(--cacador-yellow-dark))",
          orange: "hsl(var(--cacador-orange))",
          "orange-dark": "hsl(var(--cacador-orange-dark))",
          background: "hsl(var(--cacador-background))",
          foreground: "hsl(var(--cacador-foreground))",
          card: "hsl(var(--cacador-card))",
        },
        destructive: {
      ...
      backgroundImage: {
        ...
        "gradient-cacador-red": "var(--gradient-cacador-red)",
        "gradient-cacador-orange": "var(--gradient-cacador-orange)",
      ...
      boxShadow: {
        ...
        'cacador-red': 'var(--shadow-cacador-red)',
