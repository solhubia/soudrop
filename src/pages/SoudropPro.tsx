  ...
  return <div className="min-h-screen bg-black">
      ...
      <section className="relative overflow-hidden pt-12 sm:pt-16 md:pt-24 pb-16 sm:pb-20 md:pb-32 px-5 sm:px-6 md:px-4">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="text-center space-y-5 sm:space-y-6 md:space-y-10">
            <div className="inline-block">
              <span className="px-4 md:px-6 py-2.5 md:py-3 bg-blue-950/70 text-blue-400 rounded-full text-xs md:text-sm font-semibold border border-blue-800/60 tracking-wider uppercase">
                Aula Gratuita
              </span>
            </div>
            
            <h1 className="text-[1.5rem] sm:text-2xl md:text-4xl lg:text-[2.75rem] font-bold text-white leading-[1.3] sm:leading-[1.2] tracking-tight max-w-4xl mx-auto">
              Descubra como <span className="text-blue-400">vender sem estoque</span> no método que fazem até iniciantes{" "}
              <span className="text-green-400">lucrarem mais de 10 mil reais por mês</span>{" "}
              sem <span className="text-blue-400">investir em estoque</span>
            </h1>
            
            <p className="text-[15px] sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-14 sm:py-16 md:py-24 px-5 sm:px-6 md:px-4 bg-gradient-to-b from-black to-[#0A1124]/50">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center space-y-5 sm:space-y-6 md:space-y-8">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4 md:mb-5">
              O que tem por trás desse <span className="text-blue-400">método de vender sem estoque</span>?
            </h2>
            
            <p className="text-[15px] sm:text-base md:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-14 sm:py-16 md:py-24 px-5 sm:px-6 md:px-4 bg-gradient-to-b from-black to-[#0A1124]/50">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10 md:mb-16">
            ...
            <p className="text-gray-400 text-[15px] sm:text-base md:text-lg">
          ...
          <Card className="bg-red-950/30 border border-red-900/40 max-w-2xl mx-auto">
            <CardContent className="p-4 sm:p-5 md:p-7 flex items-center gap-3 sm:gap-4 md:gap-5 justify-center">
              <X className="h-5 w-5 md:h-6 md:w-6 text-red-400 flex-shrink-0" />
              <p className="text-red-300 font-medium text-center text-[15px] sm:text-sm md:text-base">
      ...
      <section className="py-14 sm:py-16 md:py-24 px-5 sm:px-6 md:px-4 bg-gradient-to-b from-[#0A1124]/50 to-black">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
            {deliverables.map((item, index) => <Card key={index} className="bg-[#0A1124]/80 border border-blue-900/40 hover:border-blue-600/70 transition-all duration-300 group">
                <CardHeader className="pb-2 sm:pb-3 md:pb-4 p-4 sm:p-5 md:p-6">
                  ...
                  <CardTitle className="text-[15px] sm:text-base md:text-lg text-white font-semibold">{item.title}</CardTitle>
                </CardHeader>
                <CardContent className="pt-0 px-4 pb-4 sm:px-5 sm:pb-5 md:px-6 md:pb-6">
                  <CardDescription className="text-gray-400 text-[13px] sm:text-xs md:text-sm leading-relaxed">
                    {item.description}
                  </CardDescription>
                </CardContent>
              </Card>)}
        ...
        <div className="container mx-auto max-w-6xl">
            ...
            {testimonials.map((testimonial, index) => <Card key={index} className="bg-[#0A1124]/80 border border-blue-800/50 hover:border-blue-600/70 transition-all duration-300">
                <CardContent className="p-4 sm:p-5 md:p-8">
                  <div className="flex items-center gap-3 md:gap-4 mb-4 sm:mb-5 md:mb-7">
                    ...
                    <div>
                      <p className="text-white font-semibold text-[15px] sm:text-sm md:text-base">{testimonial.name}</p>
          ...
          <div className="mt-8 sm:mt-10 md:mt-16 text-center">
            <Card className="bg-[#0A1124]/60 border border-blue-900/40 max-w-2xl mx-auto">
              <CardContent className="p-4 sm:p-5 md:p-6 flex flex-col sm:flex-row items-center gap-3 md:gap-4 justify-center">
                <AlertTriangle className="h-5 w-5 text-yellow-500 flex-shrink-0" />
                <p className="text-gray-300 text-[13px] sm:text-xs md:text-sm text-center sm:text-left">
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <img src={renanPhoto} alt="Renan Ferreira" className="relative rounded-2xl shadow-2xl border border-blue-900/50 w-full max-w-[280px] sm:max-w-sm mx-auto lg:max-w-full" />
            </div>
            
            <div className="space-y-4 sm:space-y-5 md:space-y-7 order-1 lg:order-2 text-center lg:text-left">
              <div>
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 md:mb-3">Quem vai te ensinar?</h3>
                <p className="text-base sm:text-lg md:text-xl text-blue-400 font-semibold">Renan Ferreira</p>
              </div>
              
              <div className="space-y-3 sm:space-y-4 md:space-y-5 text-gray-300 leading-relaxed text-[15px] sm:text-sm md:text-[16px]">
                <p>
      ...
      <section className="py-12 sm:py-14 md:py-20 px-5 sm:px-6 md:px-4 bg-gradient-to-b from-black to-[#0A1124]/50">
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-3 md:gap-5">
            <Card className="bg-[#0A1124]/80 border border-blue-900/40">
              <CardContent className="p-3 sm:p-4 md:p-7 text-center">
                <Users className="h-6 w-6 sm:h-7 sm:w-7 md:h-9 md:w-9 text-blue-400 mx-auto mb-2 sm:mb-3 md:mb-4" />
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-0.5 sm:mb-1">+500</div>
                <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-500 uppercase tracking-wider">Alunos ativos</p>
              </CardContent>
            </Card>
            
            <Card className="bg-[#0A1124]/80 border border-blue-900/40">
              <CardContent className="p-3 sm:p-4 md:p-7 text-center">
                <Activity className="h-6 w-6 sm:h-7 sm:w-7 md:h-9 md:w-9 text-blue-400 mx-auto mb-2 sm:mb-3 md:mb-4" />
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-0.5 sm:mb-1">+1000</div>
                <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-500 uppercase tracking-wider">Operações rodando</p>
              </CardContent>
            </Card>
            
            <Card className="bg-[#0A1124]/80 border border-blue-900/40">
              <CardContent className="p-3 sm:p-4 md:p-7 text-center">
                <Package className="h-6 w-6 sm:h-7 sm:w-7 md:h-9 md:w-9 text-blue-400 mx-auto mb-2 sm:mb-3 md:mb-4" />
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-0.5 sm:mb-1">+50K</div>
                <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-500 uppercase tracking-wider">Produtos validados</p>
              </CardContent>
            </Card>
            
            <Card className="bg-[#0A1124]/80 border border-blue-900/40">
              <CardContent className="p-3 sm:p-4 md:p-7 text-center">
                <Award className="h-6 w-6 sm:h-7 sm:w-7 md:h-9 md:w-9 text-blue-400 mx-auto mb-2 sm:mb-3 md:mb-4" />
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-0.5 sm:mb-1">100%</div>
                <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-500 uppercase tracking-wider">Método prático</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      {/* CTA Final */}
      <section className="py-14 sm:py-16 md:py-24 px-5 sm:px-6 md:px-4 bg-gradient-to-b from-[#0A1124]/50 to-black">
        <div className="container mx-auto max-w-3xl text-center space-y-5 sm:space-y-6 md:space-y-10">
          ...
          <p className="text-[15px] sm:text-base md:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
      ...
      {/* Footer */}
      <footer className="bg-black border-t border-blue-950/60 text-gray-600 py-6 sm:py-8 md:py-10 px-5 sm:px-6 md:px-4">
