...
const SoudropPro = () => {
  ...
  return <div className="min-h-screen bg-black overflow-x-hidden">
            ...
            <div className="order-2 lg:order-2 flex justify-center lg:justify-end items-end relative">
              <AnimatedSection delay={100} className="relative">
                ...
                <img 
                  ...
                  className="block relative z-10 w-[240px] sm:w-[300px] lg:w-[480px] xl:w-[550px] h-auto object-contain object-bottom drop-shadow-[0_0_40px_rgba(59,130,246,0.4)] lg:drop-shadow-[0_0_60px_rgba(59,130,246,0.5)]" 
                  src="/lovable-uploads/674d5177-343a-4997-b33e-139eca71667c.png"
                  loading="eager"
                />
              </AnimatedSection>
            </div>
      ...
      <section className="relative z-0 pt-0 pb-12 sm:pt-0 sm:pb-16 lg:pt-0 lg:pb-20 px-5 sm:px-6 md:px-4 bg-gradient-to-b from-black to-[#050A18]">
