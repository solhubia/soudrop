...
const ChecklistImportador = () => {
  ...
  const targetAudience = [
    "Donos de e-commerce que querem aumentar margem de lucro",
    "Vendedores de Mercado Livre, Shopee, Amazon e Magalu que sentem a margem apertar",
    "Empresários que querem parar de depender só de distribuidores nacionais",
    "Quem quer importar da China, mas ainda não tem segurança para escolher produtos"
  ];
  ...
  return (
    <div className="min-h-screen bg-[#02111B]">
      ...
      <header className="bg-[#02111B] border-b border-[#5D737E]/20 sticky top-0 z-50 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button 
              onClick={scrollToCTA}
              className="bg-[#5D737E] hover:bg-[#5D737E]/90 text-[#FCFCFC] font-semibold px-6 rounded-lg"
            >
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <Button
              onClick={scrollToCTA}
              size="lg"
              className="bg-[#5D737E] hover:bg-[#5D737E]/90 text-[#FCFCFC] text-lg px-12 py-6 font-semibold rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              Quero acessar o Caçador de Produtos
            </Button>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="text-center pt-6">
              <Button
                onClick={scrollToCTA}
                className="bg-[#5D737E] hover:bg-[#5D737E]/90 text-[#FCFCFC] px-8 py-5 rounded-lg font-semibold"
              >
                Quero acessar o Caçador de Produtos
              </Button>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {targetAudience.map((item, index) => (
              <Card key={index} className="bg-[#30292F] border-[#5D737E]/20 hover:border-[#5D737E]/40 transition-all">
          ...
          <div className="text-center mt-12">
            <Button
              onClick={scrollToCTA}
              className="bg-[#5D737E] hover:bg-[#5D737E]/90 text-[#FCFCFC] px-10 py-5 rounded-lg font-semibold text-lg"
            >
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {learningTopics.map((topic, index) => {
              ...
              return (
                <Card key={index} className="bg-[#3F4045] border-[#5D737E]/20 hover:border-[#5D737E]/40 hover:shadow-lg transition-all">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-[#3F4045] border-[#5D737E]/20 hover:border-[#5D737E]/40 transition-all">
                <CardContent className="p-8">
                  <div className="flex gap-1 mb-4">
                    {[...Array(5)].map((_, i) => (
                      <span key={i} className="text-[#5D737E] text-xl">★</span>
                    ))}
                  </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqItems.map((item, index) => (
                <AccordionItem 
                  key={index} 
                  value={`item-${index}`} 
                  className="bg-[#3F4045] border border-[#5D737E]/20 rounded-lg px-6 data-[state=open]:border-[#5D737E]/40"
                >
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="py-8">
              ...
              <p className="text-5xl md:text-6xl font-bold text-[#FCFCFC] mb-8">R$ 27,90</p>
              
              <Button
                onClick={scrollToCTA}
                size="lg"
                className="w-full md:w-auto bg-[#5D737E] hover:bg-[#5D737E]/90 text-[#FCFCFC] text-xl px-16 py-8 font-bold rounded-lg shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
              >
                Quero acessar o Caçador de Produtos
              </Button>
