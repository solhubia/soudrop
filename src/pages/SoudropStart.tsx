...
const SoudropStart = () => {
  ...
  return <div className="min-h-screen bg-forest-bg-main overflow-x-hidden">
      ...
      <section className="relative z-10 w-full overflow-visible pb-0">
        ...
        <div className="relative z-10 w-full mx-auto pl-5 pr-0 sm:px-8 lg:pl-16 lg:pr-0 pt-16 sm:pt-20 lg:pt-24 pb-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-4 items-end lg:max-w-none">
            ...
            <div className="order-2 lg:order-2 flex justify-end lg:justify-end items-end relative lg:ml-auto lg:mr-0 lg:pr-0 mr-0 pr-0">
              <AnimatedSection delay={100} className="relative lg:mr-0 mr-0">
      ...
      {/* Autoridade Section */}
      <section className="relative z-0 pt-0 pb-6 sm:pt-16 sm:pb-16 md:pt-20 md:pb-20 px-4 sm:px-6 md:px-4 bg-gradient-to-b from-forest-bg-main via-forest-bg-card to-forest-bg-main overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-8 items-center">
            <AnimatedSection className="order-2 md:order-1">
              <div className="relative">
                ...
                <img src={renanFerreira} alt="Renan Ferreira" className="block mx-auto w-full max-w-full h-auto rounded-xl shadow-2xl border border-forest-border" />
              </div>
            </AnimatedSection>
